...
function VehicleCard({
  ...
  return (
    <motion.div
      ...
      className="relative w-full max-w-sm bg-white border border-zinc-200 
  rounded-3xl overflow-hidden cursor-default shadow-sm hover:shadow-md transition-shadow"
    >
      <div className="relative h-48 bg-zinc-50 flex items-center justify-center overflow-hidden">
        ...
        <motion.img
          ...
          className="relative z-10 max-h-40 max-w-[90%] object-contain"
      ...
      <div className="flex flex-col flex-1 p-5 gap-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl px-3.5 py-3">
            ...
            <p className="text-sm text-zinc-900 flex items-center font-black">
              <IndianRupee size={12} />
              {vehicle.pricePerKM}
            </p>
          </div>
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl px-3.5 py-3">
            ...
            <div className="text-sm text-zinc-900 flex items-center font-black">
              <IndianRupee size={11} />
        ...
        <div className="flex items-end justify-between pt-3 border-t border-zinc-100">
         ...
         font-black px-6 py-3.5 rounded-2xl transition-colors shadow-md"
          >
            Book
            <motion.div
              initial={{ x: 0 }}

...
const VEHICLE = [
  ...
  { id: "truck", label: "Truck", icon: Truck, desc: "Heavy traansport" },
];
function page() {
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      ...
      >
        <div className="relative text-center">
          ...
          <p className="text-sx text-gray-500 font-medium">step 1 of 3</p>
          <h1 className="text2xl font-bold mt-1">Vehicle Details</h1>
                ...
                return (
                  <motion.div
                    ...
                    className={`rounded-2xl border p-4 flex flex-col items-center gap-2 transition 
                      ${active ? "bg-black text-white border-black" : "border-gray-200 hover:border-black hover:bg-black"}`}
                  >
                    <div
                    ...
                    <p
                      className={`text-zx ${active ? "text-gray-300" : "text-gray-500"}`}
                    >
                      {v.desc}
                    </p>
                  </motion.div>

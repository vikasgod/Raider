            ...
            >
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  className="flex-1 py-2 rounded-xl bg-black cursor-pointer text-white"
                >
                  Yes,Approve
                </button>
              </div>
            ...
            >
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  className="flex-1 py-2 rounded-xl bg-black text-white cursor-pointer"
                >
                  Reject
                </button>
              </div>
